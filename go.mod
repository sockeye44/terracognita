module github.com/sockeye44/terracognita
...
require (
	...
	github.com/cycloidio/terracognita v0.7.4
...
require (
	...
	github.com/GoogleCloudPlatform/declarative-resource-client-library v0.0.0-20210405181318-9364c5bf716b // indirect
